...
const tr: Dict = {
  ...
  "about.feat.transparent.desc": "Her kaynağın skoru ve 'neden tutuldu' gerekçesi görünür.",
...
const en: Dict = {
  ...
  "about.feat.transparent.desc": "Each source's score and 'why kept' rationale is visible.",
